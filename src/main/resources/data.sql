...
insert into mk_param(facade_id, fid, name, desc, type, mock)
  values(1, null, 'orderId', '订单id', 'String', '');
insert into mk_param(facade_id, fid, name, desc, type, mock)
  values(1, null, 'merId', '商户id', 'String', '');
insert into mk_param(facade_id, fid, name, desc, type, mock)
  values(2, null, 'accountNo', '账户编号', 'String', '');